...
bool Tableau_find_and_remove_matches(Tableau *b, int *points); // Trouve et supprime les correspondances, retourne vrai si des correspondances ont été trouvées
void Tableau_swap(Tableau *b, int r1,int c1,int r2,int c2); // Échange deux cellules du plateau
bool Tableau_no_initial_matches(Tableau *b); // Vérifie qu'il n'y a pas de correspondances initiales sur le plateau
